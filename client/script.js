...
wallpaper.onclick = () => {
    if (wallpaperToggle === 'gradient') {
        document.body.style.backgroundImage = 'url(https://raw.githubusercontent.com/basnijholt/lovelace-ios-dark-mode-theme/master/backgrounds/homekit-bg-4.jpeg)';
...
let operate = (sym, func) => {
    if (
        ...
        oldNumber = func(oldNumber, current.innerHTML);
        current.innerHTML = '';
        history.innerHTML = oldNumber + ' ' + sym;
        usedEqual = oldNumber;
